...
sandbox("initializing jquery", function () { 
    if (chromium) {
...
/*global local_window, storage: true, alert, document, chromium, decodeURIComponent, running: true, sandbox */
...
sandbox("chat options menu", function () {
    ...
    function track(input, binding, default_value) {
