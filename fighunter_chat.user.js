...
/* JQUERY */
/*
    Apparently Chromium refuses to hoist jQuery to the 
    top of the file in some peoples' versions. Thus, 
    unfortunately, it has to be placed here manually.
    
    Skip to "PRELUDE" if you want the rest of the code.
*/
 
function build_jquery(win) {
/*!
...
/*global alert, document, window, unsafeWindow, decodeURIComponent, build_jquery */
...
sandbox("init public api", function () {
    "use strict";
    jQuery("body").get(0).dchat = dchat;
});
...
sandbox("chat options menu", function () {
    ...
    menu = $(
        ...
        '<li style="position: relative; top: 5px;">dchat version: ' + version + '</li>' + 
    ...
    $("a", topbar).filter(function () {
        return this.getAttribute("href") === "?page=editstats";
    }).before(
